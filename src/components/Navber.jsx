...
const Navbar = () => {
  ...
  return (
    <div className="bg-slate-100f py-2 border-b border-b-slate-300 md:w-11/12 mx-auto w-full">
      <div className="flex items-center justify-between">
        ...
        <ul id="navUl" className="flex flex-col md:flex-row items-center gap-2">
          <li>
