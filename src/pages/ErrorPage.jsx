        ...
        <div className='min-h-screen flex flex-col justify-center items-center'>
            ...
            <div>
                ...
                <div className='flex flex-col gap-[16px] justify-center items-center'>
                    ...
                    <NavLink to={'/'} className='w-[150px] h-12 flex justify-center items-center gap-2.5 py-3 px-4 rounded-[4px] bg-[linear-gradient(125.07deg,rgba(99,46,227,1),rgba(159,98,242,1)_100%)] text-white font-bold cursor-pointer'>Go Back!</NavLink>
                </div>
            </div>
        </div>
    );
